...
<div class="m-4">
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h4 class="font-weight-bold m-2">Liste des demandes changement de RIB</h4>
        </div>
        <div class="card-body">
                        ...
                        <td class="d-flex">
                            ...
                            <div class="modal fade" id="{{'model_'.$demande->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title" id="exampleModalLongTitle ">Changement de RIB @if (Auth::user()->role == 'admin') par : {{ $demande->nomComplet }} @endif</h5>
