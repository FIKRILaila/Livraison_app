...
class RapportsController extends Controller
{
    ...
    public function Nouveau(Request $request){
        ...
        $total = 0;
        $lines =  Facture_rapport::join('factures','factures.id','=','facture_rapports.facture_id')->join('users','users.id','=','factures.client_id')->where('facture_rapports.rapport_id','=',$rapport->id)->select('factures.*','users.nomComplet','users.nomMagasin','users.RIB')->get();
        // $lines = Facture::join('users','users.id','=','factures.client_id')->where('factures.date','=', $date)->where('factures.etat_f','=','Non Facturé')->select('factures.*','users.nomComplet','users.nomMagasin','users.RIB')->get();
        $html = '
        <!DOCTYPE html>
        <html lang="fr">
        <head>
